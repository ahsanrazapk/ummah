...
class UnPaidTab extends BaseStateFullWidget {
  UnPaidTab({Key? key}) : super(key: key);

  @override
  UnPaidState createState() => UnPaidState();
}

class UnPaidState extends State<UnPaidTab> {
  @override
                            ...
                            child: Stack(
                              ...
                              AnimatedPositioned(
                                ...
                                child: SectionBox(
                                  ...
                                  child: Text(
                                    'Unpaid Fee',
                                    style: context.textTheme.caption?.copyWith(color: Style.card1),
                                  ),
                                ),
                              ),
                              Positioned(
