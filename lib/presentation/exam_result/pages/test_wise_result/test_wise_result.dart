...
class TestWiseResultState extends State<TestWiseResult> with ExamResultBaseMixin , TestWiseResultMixin {
  final List<ChartData> chartData = [
    ChartData('ABC-01', 80, Style.primary,100),
    ChartData('ABC-02', 70, Style.primary, 50),
    ChartData('ABC-03', 90, Style.primary, 39),
    ChartData('ABC-04', 30, Style.primary,70),
    ChartData('ABC-05', 50, Style.primary, 40),
    ChartData('ABC-06', 20, Style.primary, 30),
    ChartData('ABC-07', 70, Style.primary,100),
    ChartData('ABC-08', 45, Style.primary,30),
  ];
                                  ...
                                  SfCartesianChart(
                                      ...
                                      series: <ChartSeries<ChartData, String>>[
                                        ...
                                        ColumnSeries<ChartData, String>(
                                          ...
                                          pointColorMapper: (ChartData data, _) => data.y1! < 40 ? Style.red : Style.accent1,
                                        )
                                      ])
                                ],
                              ),
