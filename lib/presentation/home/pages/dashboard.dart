      ...
      body: StreamBuilder<HomeResponseModel>(
          ...
          builder: (context, AsyncSnapshot<HomeResponseModel> snapshot) {
            ...
            if (snapshot.hasData && snapshot.data != null) {
              ...
              final _u = (data.loginResponse).data;
                  ...
                  children: [
                              ...
                              children: [
                                SectionBigTitleWithIcon(
                                  ...
                                  titleStyle: context.textTheme.headline5?.copyWith(
                                      color: Style.title1, fontSize: widget.dimens.k18, fontWeight: FontWeight.w600),
                    ...
                    StaggeredGridTile.count(
                      ...
                      child: SectionBox(
                        ...
                        widget.navigator.pushNamed(RoutePath.profile, object: _u);
                      }),
                    ),
                    StaggeredGridTile.count(
                      crossAxisCellCount: 2,
